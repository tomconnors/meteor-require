(function() {
  ...
  //once all the modules have had a chance to resolve, give
  // a notice of any that went unresolved.
  // todo: this sometimes lies.
  _.defer(function(){
    if(!_.isEmpty(waitingModules)){
      console.log("Some modules are unresolved:", waitingModules)
    }
  });
